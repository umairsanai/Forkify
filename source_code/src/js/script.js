        ...
        <div class="preview__data">
          ...
          ${recipe.id.includes(APIKEY) && addTo === recipePreviewContainer ? 
            `<div class="preview__user-generated">
              <svg>
                <use href="/icons.4c95ab8c.svg#icon-user"></use>
              </svg>
            </div>` : ""}
        </div>
      </a>
...
const displayFullRecipe = function(recipe) {
  ...
  fullRecipeBookmarkButton.querySelector("use").setAttribute("href", `/icons.4c95ab8c.svg#icon-bookmark${bookmarks.find(bookmark => bookmark.id === recipe.id) ? "-fill" : ""}`);
...
fullRecipeBookmarkButton.addEventListener("click", () => {
  ...
  fullRecipeBookmarkButton.querySelector("use").setAttribute("href", `/icons.4c95ab8c.svg#icon-bookmark${bookmarks.find(book => book.id === openedRecipe.id) ? "-fill" : ""}`);
  updateBookmarks();
});
